...
public final class ActivityAddTaskBinding implements ViewBinding {
  ...
  private ActivityAddTaskBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
      @NonNull Button btnSave, @NonNull EditText etTaskTitle, @NonNull ProgressBar progress) {
  ...
  public static ActivityAddTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddTaskBinding((LinearLayout) rootView, btnCancel, btnSave, etTaskTitle,
          progress);
    }
